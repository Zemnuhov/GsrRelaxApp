package com.example.impl_ble_communication
...
class AppBluetoothManager @Inject constructor (
    ...
    override fun log(priority: Int, message: String) {
        if (isLog) {
            Log.e(this.javaClass.name, "$message. Priority $priority")
        }
    ...
    private fun dataCharacteristicInit(dataService: BluetoothGattService): Boolean {
        ...
        Log.e(
            this.javaClass.name,
            "$phaseFlowCharacteristic -- $tonicFlowCharacteristic -- $timeCharacteristic -- $dateCharacteristic"
        )
    ...
    suspend fun getPeaks(): PhaseEntityFromDevice? {
        ...
        return try {
            ...
            Log.e(this.javaClass.name, "Write Phase in background")
